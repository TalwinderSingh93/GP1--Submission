...
#define WINDOW_TITLE "Helicopter Run - Coursework P1"
...
enum gameState { MENU, INSTRUCTIONS, SCORE, PLAYING, END, QUIT };
enum btnTypes { EXIT, INSTRUCT, HIGHSCORE, GOTOMENU, PLAY, PLAYAGAIN };
#endif